...
int main()
{
    ...
    std::cout << "std::strlen(dest1) :" << std::strlen(dest1) << std::endl;      // 8
    std::cout << "std::strlen(source1) : " << std::strlen(source1) << std::endl; // 17

    std::cout << "Concatenating..." << std::endl;
    std::strcat(dest1, source1);

    std::cout << "std::strlen(dest1) :" << std::strlen(dest1) << std::endl; // 25
    std::cout << "dest1 : " << dest1 << std::endl;                          // Firelord,The Phenix King!
    ...
    std::cout << std::strncat(dest2, source2, 6) << std::endl; // Hello There
    ...
    char *dest3 = new char[std::strlen(source3) + 1]; // +1 for the null character
                                                      ...
                                                      // dest3 Not initialized

    std::strcpy(dest3, source3);

    std::cout << "sizeof(dest3) : " << sizeof(dest3) << std::endl;           // 4 - it is a pointer
    std::cout << "std::strlen(dest3) : " << std::strlen(dest3) << std::endl; // 43
    std::cout << "dest3 : " << dest3 << std::endl;                           // C++ is a multipurpose programming language.
    ...
    std::cout << "dest4 : " << dest4 << std::endl; // abcdef
