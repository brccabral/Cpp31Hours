...
int main()
{
...

    {
        ...
        // local_var is deleted automatically because the scope has ended
    }

    // local_var = 4; // Can't access local_var because it is not in the same scope
    ...
    *p_number4 = 77; // Writting into dynamically allocated memory
    ...
    delete p_number5;
    // delete p_number5; // Calling delete twice on a pointer : BAD!
