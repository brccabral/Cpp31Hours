...
int main()
{
    ...
    std::cout << "pos_num : " << pos_num << std::endl; // +34 - has the plus sign
    std::cout << "neg_num : " << neg_num << std::endl; // -34

    std::cout << std::endl;
    std::cout << std::noshowpos;
    std::cout << "pos_num : " << pos_num << std::endl; // 34 - hides plus sign
    std::cout << "neg_num : " << neg_num << std::endl; // -34
    ...
    std::cout << std::endl;
    std::cout << "double_var in different bases : " << std::endl; // doesn't change the format
    ...
    // hexadecimal uppercase and nouppercase // af12bc >> AF12BC
    ...
    std::cout << "d : " << d << std::endl; // 34.100000000000001421 - shows decimal if number has decimal
    std::cout << "e : " << e << std::endl;
    std::cout << "f : " << f << std::endl; // 12 - doesn't show only if decimal is 0 or int
    ...
    std::cout << "g : " << g << std::endl; // 45 - doesn't show point because it is int
